 ...
 * Tested on: macOS Mojave (10.14.1) -> PENDING
 * 
 * Works on network level comunication
 * 
...
using XIUNetworkingLib.Cryptography;

namespace XIUNetworkingLib
{

    public enum MessageAuthAlgo
    {
        HMACSHA256,
        NOALGO
    }
    ...
    public class Client
    {
         ...
         * +-------------+-------------+-----------------+-------------------+-------------+----------------+-----------+--------------------+--------------------+---------------+--------------+
         * |  DATA SIZE  | PACKET TYPE |    IS ENCRYPTED | HAS HMAC/MAC/HASH | CIPHER ALGO | CIPHER IV SIZE | CIPHER IV | HMAC/MAC/HASH ALGO | HMAC/MAC/HASH SIZE | HMAC/MAC/HASH |     DATA     |
