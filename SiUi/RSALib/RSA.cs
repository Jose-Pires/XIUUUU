...
namespace RSALib
{
    public class RSAlib
    {
        ...
        public List<KeyList> ListaDeChaves= new List<KeyList>();
        ...
        public byte[] EncryptToByte(string message, string EtName = null)
        {
            ...
            RSACryptoServiceProvider rsa = new RSACryptoServiceProvider();
            RSAParameters x = ListaDeChaves.Where(var => var.Entity.Equals(EtName)).FirstOrDefault().PublicKey;
            rsa.ImportParameters(x);
        ...
        {
            ListaDeChaves.Add(new KeyList { Entity = EtName, PublicKey = EtParameters });
